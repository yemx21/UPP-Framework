...
namespace System
{
	namespace Audio
	{
		...
		__uclass __uobjdef(asm = Audio_Device_Wasapi, ns = System::Audio, ver = 1.0)  AudioDevice_Wasapi : public AudioDevice_base
		{
		private:
			...
			static AudioDevice_Wasapi * instance;
			std::vector<WasapiPipe*> Pipes;
		protected:
			AudioDevice_Wasapi();

			AudioDevice_Wasapi(const AudioDevice_Wasapi&) = delete;

		public:
			__udefctor static AudioDevice_Wasapi* Create();
		...
		public:
			...
			REFLECT_CLASS(AudioDevice_Wasapi)
