...
namespace System
{
	...
	/// 台湾阴阳历类
	/// </summary>
	 class RUNTIME_API TaiwanLunisolarCalendar : public EastAsianLunisolarCalendar
	{
	protected:
	...
	public:
		...
		/// <summary>
		/// 创建<see cref="TaiwanLunisolarCalendar"/>实例.
		/// </summary>
		TaiwanLunisolarCalendar();

		virtual ~TaiwanLunisolarCalendar();
		...
		REFLECT_CLASS(TaiwanLunisolarCalendar)
	};
}