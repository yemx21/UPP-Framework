...
namespace System
{
	...
	/// 韩国阴阳历类
	/// </summary>
	 class RUNTIME_API KoreanLunisolarCalendar : public EastAsianLunisolarCalendar
	{
	protected:
	...
	public: 
		...
		/// <summary>
		/// 创建<see cref="KoreanLunisolarCalendar"/>实例.
		/// </summary>
		...
		REFLECT_CLASS(KoreanLunisolarCalendar)
	};
}