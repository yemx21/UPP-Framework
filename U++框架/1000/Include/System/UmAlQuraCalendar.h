...
namespace System
{
	...
	/// 沙特阿拉伯回历日历类
	/// </summary>
	 class RUNTIME_API UmAlQuraCalendar : public Calendar
	{
	protected:
		...
		virtual int GetDatePart(const DateTime& time, int part) const;
	...
	public:
		...
		/// <summary>
		/// 创建<see cref="UmAlQuraCalendar"/>实例.
		/// </summary>
		UmAlQuraCalendar();

		virtual ~UmAlQuraCalendar();
		...
		REFLECT_CLASS(UmAlQuraCalendar)
	};
}