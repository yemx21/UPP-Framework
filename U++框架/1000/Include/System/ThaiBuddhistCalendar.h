...
namespace System
{
	...
	/// 泰国佛教日历类
	/// </summary>
	 class RUNTIME_API ThaiBuddhistCalendar : public Calendar
	{
	protected:
	...
	public:
		...
		/// <summary>
		/// 创建<see cref="ThaiBuddhistCalendar"/>实例.
		/// </summary>
		ThaiBuddhistCalendar();

		virtual ~ThaiBuddhistCalendar();
		...
		REFLECT_CLASS(ThaiBuddhistCalendar)
	};
}